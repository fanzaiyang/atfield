...
public class FileUploadServiceImpl implements FileUploadService {
    private FileUploadProperty.MinioServerConfig config;
    ...
    @Override
    public void setConfig(FileUploadProperty.MinioServerConfig config) {
        this.config = config;
    ...
    @Override
    public FileUploadService bucket(String bucket) {
