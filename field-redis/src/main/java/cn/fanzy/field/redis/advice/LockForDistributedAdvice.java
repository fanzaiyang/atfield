...
import cn.fanzy.field.redis.annotation.Lock;
import cn.fanzy.field.redis.exception.LockException;
...
public class LockForDistributedAdvice {
    ...
    @Pointcut("@annotation(cn.fanzy.field.redis.annotation.Lock)")
    public void cut() {
    }
