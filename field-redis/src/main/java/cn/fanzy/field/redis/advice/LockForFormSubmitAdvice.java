...
import cn.fanzy.field.redis.annotation.LockForm;
import cn.fanzy.field.redis.enums.FormSubmitType;
import cn.fanzy.field.redis.exception.LockFormException;
...
public class LockForFormSubmitAdvice {
    ...
    @Pointcut("@annotation(cn.fanzy.field.redis.annotation.LockForm)")
    public void cut() {
    }
