package cn.fanzy.atfield.tlog.core.aop;

import cn.fanzy.atfield.tlog.common.constant.TLogConstants;
import cn.fanzy.atfield.tlog.common.exception.TLogCustomLabelExpressionException;
import cn.fanzy.atfield.tlog.core.annotation.TLogAspect;
...
public class AspectLogAop {
    ...
    @Pointcut("@annotation(cn.fanzy.atfield.tlog.core.annotation.TLogAspect)")
    public void cut() {
    }
