package cn.fanzy.field.web.json.model;

import cn.fanzy.field.tlog.common.context.TLogContext;
import cn.fanzy.field.web.configuration.JsonModelAutoConfiguration;
...
public class Json<T> implements Serializable {
    ...
    public String getTraceId() {
        ...
        try {
            Class<?> forName = Class.forName("cn.fanzy.field.tlog.common.context.TLogContext");
