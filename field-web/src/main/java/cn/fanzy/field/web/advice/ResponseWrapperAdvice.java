package cn.fanzy.field.web.advice;

import cn.fanzy.field.core.spring.SpringUtils;
import cn.fanzy.field.core.utils.Constants;
import cn.fanzy.field.web.json.model.Json;
import cn.fanzy.field.web.response.annotation.ResponseWrapper;
import cn.fanzy.field.web.response.property.ResponseWrapperProperty;
...
@ConditionalOnProperty(prefix = "at.field.web.response.wrapper", name = {"enable"}, havingValue = "true", matchIfMissing = true)
public class ResponseWrapperAdvice implements ResponseBodyAdvice<Object> {
    ...
    public boolean supports(MethodParameter returnType, Class<? extends HttpMessageConverter<?>> converterType) {
        ...
        if (properties.getGlobal() != null && properties.getGlobal()) {
            ...
            return Constants.SWAGGER_LIST.stream()
