...
public class SqltoyAutoConfiguration {
    ...
    SqlToyContext sqlToyContext(
        ...
        if (properties.getSqlResources() != null && properties.getSqlResources().length > 0) {
            List<String> resList = new ArrayList<>(Arrays.asList(properties.getSqlResources()));
        ...
        sqlInterceptorList.add(applicationContext.getBean("logicDelFilterInterceptor",
                LogicDelFilterInterceptor.class));
