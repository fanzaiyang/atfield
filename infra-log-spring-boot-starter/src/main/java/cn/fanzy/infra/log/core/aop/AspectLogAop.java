package cn.fanzy.infra.log.core.aop;

import cn.fanzy.infra.log.common.constant.TLogConstants;
import cn.fanzy.infra.log.common.exception.TLogCustomLabelExpressionException;
import cn.fanzy.infra.log.core.annotation.TLogAspect;
import cn.fanzy.infra.log.core.context.AspectLogContext;
import cn.fanzy.infra.log.core.convert.AspectLogConvert;
...
public class AspectLogAop {
    ...
    @Pointcut("@annotation(cn.fanzy.infra.log.core.annotation.TLogAspect)")
    public void cut() {
    }
