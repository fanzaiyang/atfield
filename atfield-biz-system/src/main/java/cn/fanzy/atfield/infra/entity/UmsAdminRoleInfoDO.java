 ...
 * @version 1.0.0
 */
@Schema(description = "用户角色对应表")
@EqualsAndHashCode(callSuper = true)
@Data
@Accessors(chain = true)
@Entity(tableName = "ums_admin_role_info", comment = "用户角色对应表", pk_constraint = "PRIMARY")
public class UmsAdminRoleInfoDO extends BaseEntity implements Serializable {

    @Serial
    private static final long serialVersionUID = 3073065056148081924L;
     ...
     * default constructor
     */
    public UmsAdminRoleInfoDO() {
    }

    /**
     * pk constructor
     */
    public UmsAdminRoleInfoDO(String id) {
        this.id = id;
    }
