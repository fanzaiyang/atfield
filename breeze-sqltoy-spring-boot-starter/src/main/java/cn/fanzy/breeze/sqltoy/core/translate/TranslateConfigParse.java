package cn.fanzy.breeze.sqltoy.core.translate;
...
import cn.fanzy.breeze.sqltoy.core.callback.XMLCallbackHandler;
import cn.fanzy.breeze.sqltoy.core.config.ScanEntityAndSqlResource;
...
import cn.fanzy.breeze.sqltoy.core.translate.model.CheckerConfigModel;
import cn.fanzy.breeze.sqltoy.core.translate.model.DefaultConfig;
...
public class TranslateConfigParse {
	...
	public static HashMap<String, Translate> getClassTranslates(Class classType) {
		...
		cn.fanzy.breeze.sqltoy.core.config.annotation.Translate translate;
		Class classVar = classType;
		while (classVar != null && !classVar.equals(Object.class)) {
			for (Field field : classVar.getDeclaredFields()) {
				translate = field.getAnnotation(cn.fanzy.breeze.sqltoy.core.config.annotation.Translate.class);
				// 以子类注解为优先
