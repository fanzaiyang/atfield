...
import cn.fanzy.breeze.sqltoy.core.config.model.NoSqlFieldsModel;
...
import cn.fanzy.breeze.sqltoy.core.utils.MongoElasticUtils;
...
public class Mongo extends BaseLink {
	...
	private MongoQuery getMongoQuery() throws Exception {
		if (this.mongoQuery == null) {
			mongoQuery = sqlToyContext.getMongoQuery();
