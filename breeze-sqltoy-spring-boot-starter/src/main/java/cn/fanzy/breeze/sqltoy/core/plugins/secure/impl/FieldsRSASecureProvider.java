package cn.fanzy.breeze.sqltoy.core.plugins.secure.impl;
...
public class FieldsRSASecureProvider implements FieldsSecureProvider {
    ...
    public FieldsRSASecureProvider(SqlToyContextProperties properties) throws Exception {
        this.properties = properties;
        this.initialize(properties.getEncoding(), properties.getSecurePrivateKey(), properties.getSecurePublicKey());
    }
