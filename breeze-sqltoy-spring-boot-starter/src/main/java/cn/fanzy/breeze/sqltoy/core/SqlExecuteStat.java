...
import cn.fanzy.breeze.sqltoy.core.config.model.SqlExecuteLog;
import cn.fanzy.breeze.sqltoy.core.config.model.SqlExecuteTrace;
import cn.fanzy.breeze.sqltoy.core.model.OverTimeSql;
...
public class SqlExecuteStat {
	...
	public static String getFirstTrace() {
		...
		for (int i = length - 1; i > 0; i--) {
			...
			if (className.startsWith("cn.fanzy.breeze.sqltoy")) {
