...
public class BreezeWebExceptionConfiguration {
    ...
    public Object handleHttpMessageNotReadableException(HttpServletRequest request, HttpMessageNotReadableException e) {
        ...
        JsonContent<String> response = new JsonContent<String>(HttpStatus.BAD_REQUEST.value(), StrUtil.blankToDefault(e.getMessage(), "参数解析失败"));
    ...
    public Object handleIllegalArgumentException(HttpServletRequest request, IllegalArgumentException e) {
        String ssid = this.getRequestId(request);
        JsonContent<String> response = new JsonContent<String>(HttpStatus.BAD_REQUEST.value(), StrUtil.blankToDefault(e.getMessage(), "参数不符合要求"));
    ...
    public Object handleHttpRequestMethodNotSupportedException(HttpServletRequest request,
        ...
        String ssid = this.getRequestId(request);
        JsonContent<String> response = new JsonContent<String>(HttpStatus.METHOD_NOT_ALLOWED.value(), StrUtil.blankToDefault(e.getMessage(), "不支持当前请求方法"));
    ...
    public Object handleHttpMediaTypeNotSupportedException(HttpServletRequest request,
        ...
        String ssid = this.getRequestId(request);
        JsonContent<String> response = new JsonContent<String>(HttpStatus.METHOD_NOT_ALLOWED.value(), StrUtil.blankToDefault(e.getMessage(), "不支持当前媒体类型"));
    ...
    public Object handleNullPointerException(HttpServletRequest request, NullPointerException e) {
        String ssid = this.getRequestId(request);
        e.printStackTrace();
        JsonContent<String> response = new JsonContent<String>(HttpStatus.INTERNAL_SERVER_ERROR.value(), StrUtil.blankToDefault(e.getMessage(), "逻辑发生空指针异常！"));
    ...
    public Object handleMissingServletRequestParameterException(HttpServletRequest request,
        ...
        String ssid = this.getRequestId(request);
        JsonContent<String> response = new JsonContent<String>(HttpStatus.BAD_REQUEST.value(), StrUtil.blankToDefault(e.getMessage(), "请求参数有误"));
    ...
    public Object handle(HttpServletRequest request, ValidationException e) {
        String ssid = this.getRequestId(request);
        JsonContent<String> response = new JsonContent<String>(HttpStatus.BAD_REQUEST.value(), StrUtil.blankToDefault(e.getMessage(), "非法参数"));
    ...
    public Object handleIndexOutOfBoundsException(HttpServletRequest request, IndexOutOfBoundsException e) {
        String ssid = this.getRequestId(request);
        JsonContent<String> response = new JsonContent<String>(HttpStatus.INTERNAL_SERVER_ERROR.value(), StrUtil.blankToDefault(e.getMessage(), "未查询到对应的数据"));
