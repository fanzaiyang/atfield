package cn.fanzy.field.tlog.print.advice;

import cn.fanzy.field.core.spring.SpringUtils;
import cn.fanzy.field.core.utils.AdviceUtil;
import cn.fanzy.field.core.utils.Constants;
import cn.fanzy.field.core.utils.ExceptionUtil;
import cn.fanzy.field.tlog.common.context.TLogContext;
import cn.fanzy.field.tlog.configuration.property.TLogProperty;
import cn.fanzy.field.tlog.print.annotation.Log;
import cn.fanzy.field.tlog.print.bean.PrintLogInfo;
import cn.fanzy.field.tlog.print.callback.LogCallbackService;
import cn.fanzy.field.tlog.print.callback.LogUserCallbackService;
...
@ConditionalOnProperty(prefix = "at.field.web.enable-invoke-time-print", name = {"enable"}, havingValue = "true", matchIfMissing = true)
public class TLogWebInvokeTimeAdvice {
    ...
    @Pointcut("@annotation(org.springframework.web.bind.annotation.RequestMapping)||" +
            ...
            "@annotation(cn.fanzy.field.tlog.print.annotation.Log)")
    public void cut() {
    }
