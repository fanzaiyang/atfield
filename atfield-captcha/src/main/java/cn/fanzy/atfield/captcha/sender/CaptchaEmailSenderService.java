...
//            + "                </td>"
                                                ...
                                                + "            margin-right: 0px" + "        '}'" + "    </style>" + "    <style id='netease_mail_footer_style' type='text/css'>" + "        #netease_mail_footer '{'"
                                                + "            display: none;" + "        '}'" + "    </style>" + "    <style id='ntes_link_color' type='text/css'>" + "        a," + "        td a '{'"
