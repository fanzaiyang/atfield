...
import cn.fanzy.infra.auth.property.AuthProperty;
...
@ConditionalOnProperty(prefix = "infra.auth.annotation", name = {"enable"}, havingValue = "true", matchIfMissing = true)
public class SaTokenAnnotationConfiguration implements WebMvcConfigurer {

    private final AuthProperty properties;
